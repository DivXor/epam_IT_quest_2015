...
function drawCharMaze(data) {
    ...
    var image = mazeCanvas.toDataURL("image/png");
    document.getElementById('charsMaze').innerHTML = "<img src='" + image + "'>";
}
...
function drawNumberMaze(data) {
    ...
    var image = mazeCanvas.toDataURL("image/png");
    document.getElementById('numbersMaze').innerHTML = "<img src='" + image + "'>";
}
...
function drawMaze(mazeData, mazeCanvas) {
    ...
    mazeCanvas.width = wx * cellSize + cellSize * 2;
    mazeCanvas.height = wy * cellSize + cellSize * 2;
    ...
    ctx.strokeRect(0, 0, wx * cellSize, wy * cellSize);
