...
-- -----------------------------------------------------
-- Table `it_quest`.`WRONG_PICTURE`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `it_quest`.`WRONG_PICTURE` ;

CREATE TABLE IF NOT EXISTS `it_quest`.`WRONG_PICTURE` (
  `ID` INT NULL AUTO_INCREMENT COMMENT '',
  `ANSWER_PICTURE_NUMBER` INT NULL COMMENT '',
